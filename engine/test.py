...
#   -d '{"from_peer": "1a", "message": "{\"_lctype\":-1,\"_lctext\":\"这是一个纯文本消息\",\"_lcattrs\":{\"a\":\"_lcattrs 是用来存储用户自定义的一些键值对\"}}", "conv_id": "58d8787ca0bb9f005af5eb6e"}' \
...
#   -H "X-LC-Key: 86bDxHaspqbCjqxWm53txUxb,master" \
#   -H "Content-Type: application/json" \
#   -d '{"conv_id": "58d87ab18d6d810061627b75", "client_id": "fuck"}' \
